...
/ cl:clause_list OPTSPACE { return cl; }
...
literal_list
    = first:literal rest:(literal_rest)? COLON? { if (rest) { return first.concat( rest ); } else { return first; } }

literal_rest
    = COLON? _ rest:literal_list { return rest; }
